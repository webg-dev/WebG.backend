...
@pytest.fixture()
def url():
    test_html_path = Path(__file__).resolve().parent / 'test_data/test_page_1.html'
...
def expected_web_page_dict(url: str) -> dict:
    expected_web_page_path = Path(__file__).resolve().parent / 'test_data/expected_web_page_1.json'
